...
export const INTERVIEW_GREETING_PROMPT = (role, candidateName) => `You are Natalie, a friendly and professional interviewer conducting a ${role} interview.
...
export const FOLLOW_UP_PROMPT = (role, conversationHistory, nextQuestion) => `You are Natalie, a friendly and conversational interviewer conducting a ${role} interview.
...
export const FEEDBACK_PROMPT = (role, conversationHistory, codeSubmissions) => `You are an expert interview evaluator. Analyze this complete ${role} interview and provide detailed feedback.
...
export const EVALUATE_CODE_PROMPT = (question, code, language, codeType) => `You are an expert code reviewer evaluating a candidate's solution during a technical interview.
